...
export default function SimpleMusicSelector({ onSelectMusic, onClose, selectedMusic }) {
  ...
  const loadMusic = (category) => {
    setLoading(true);
    console.log('🎵 Loading music for category:', category);
    
    setTimeout(() => {
      const data = musicDatabase[category] || musicDatabase.trending;
            ...
            <div className="flex-1 p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => {
                      if (lyrics && 'speechSynthesis' in window) {
              ...
              <AnimatePresence>
                {(showLyrics || true) && (
                  <motion.div
                    ...
                    className="text-gray-300 text-sm leading-relaxed whitespace-pre-line bg-gray-900/50 p-4 rounded-lg max-h-64 overflow-y-auto"
                  >
